...
ENtexts = {
    "ENG": {
        ...
        "notifications_settings_title": (
            "🔔 <b>Available slot notifications</b>\n\n"
        ...
        "quick_book_success": "✅ <b>You have successfully booked the available slot!</b>\n\n🧺 {m_type} #{m_num}\n📅 Date: {date}\n⏰ Time: {time}",
        ...
        "discipline_banned_alert": "🚫 <b>Warning:</b> your score reached -1000. Booking is locked. Please contact the dorm manager.",
